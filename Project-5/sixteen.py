...
class WordFrequencyController(TFExercise):
    ...
    def run(self):
        ...
        for (w, c) in word_freqs[0:25]:
            print w, ' - ', c
    def info(self):
        print(super(WordFrequencyController,self).info() + ": Classes I manage " + self._storage_manager.__class__.__name__ + " " + self._stop_word_manager.__class__.__name__+" "+ self._word_freq_manager.__class__.__name__ +"\n"+"Methods implemented are:\n" + "- run(self)\n"+ "- info(self)\n")
